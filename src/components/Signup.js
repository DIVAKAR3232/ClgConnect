...
const Signup = () => {
  ...
  return (
    <div style={{backgroundColor:'#edecf1',height:'100vh',display:'flex',justifyContent:'center',alignItems:'center'}}>
        <div className='bg-white px-14 py-7  text-black space-y-4 rounded'>
        ...
        <p >
            If you already have Account <Link to="/Login" className="text-black font-bold hover:text-blue-600 hover:shadow-2xl transition">LogIn</Link> | <Link to="/" className="text-black font-bold hover:text-blue-600">Home</Link>
        </p>
